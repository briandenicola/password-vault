...
then
    ...
    az functionapp create --name ${maintenanceFuncName} --storage-account ${funcStorageName} --consumption-plan-location ${region} --resource-group ${RG} --os-type Linux --functions-version 4 --runtime python  --runtime-version 3.8
