...
def main(mytimer: func.TimerRequest) -> None:
    ...
    key_to_get="primary"; key_to_rotate="secondary"
    if datetime.datetime.now().weekday() % 2 == 0:
        key_to_get="secondary"; key_to_rotate="primary"
    ...
    if key_to_get == "primary":
        ...
        new_connection_string = "AccountEndpoint=https://{0}.documents.azure.com:443/;AccountKey={1};".format(COSMOS_DB_ACCOUNT, keys.secondary_master_key)
